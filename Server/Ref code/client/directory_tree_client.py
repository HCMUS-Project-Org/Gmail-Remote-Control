...
class DirectoryTree_UI(Canvas):
    def __init__(self, parent, client):
        ...
        ysb = ttk.Scrollbar(self.frame, orient='vertical',
                            command=self.tree.yview)
        xsb = ttk.Scrollbar(self.frame, orient='horizontal',
        ...
        self.button_2 = Button(self, text='SHOW', width=20, height=5, font=self.my_font, bg="#011111", fg="white",
        ...
        self.button_3 = Button(self, text='SEND FILE\nTO FOLDER', width=20, height=5, font=self.my_font, bg="#011111", fg="white",
        ...
        self.button_4 = Button(self, text='COPY FILE', width=20, height=5, font=self.my_font, bg="#011111", fg="white",
        ...
        self.button_5 = Button(self, text='DELETE', width=20, height=5, font=self.my_font, bg="#011111", fg="white",
        ...
        self.button_6 = Button(self, text='BACK', width=20, height=5, font=self.my_font, bg="#704C25", fg="white",
    ...
    def open_node(self, event):
        ...
        if abspath:
            ...
            try:
                ...
                for p in dirs:
                    self.insert_node(
                        node, p[0], os.path.join(abspath, p[0]), p[1])
            except:
                messagebox.showerror(message="Cannot open this directory!")
    ...
    def select_node(self, event):
        ...
        while parent:
            self.currPath = os.path.join(self.tree.item(parent)[
                                         'text'], self.currPath)
            item = parent
            parent = self.tree.parent(item)
