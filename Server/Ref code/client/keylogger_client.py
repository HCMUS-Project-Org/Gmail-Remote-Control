...
class Keylogger_UI(Canvas):
    def __init__(self, parent, client):
        ...
        self.button_2 = Button(self, text='HOOK', font=self.my_font, width=20, height=5, fg='white', bg='#011111',
        ...
        self.button_3 = Button(self, text='PRINT', font=self.my_font, width=20, height=5, fg='white', bg='#011111',
        ...
        self.button_4 = Button(self, text='DELETE', font=self.my_font, width=20, height=5, fg='white', bg='#011111',
        ...
        self.button_5 = Button(self, text='LOCK', font=self.my_font, width=20, height=5, fg='white', bg='#011111',
        ...
        self.button_6 = Button(self, text='BACK', font=self.my_font, width=20, height=5, fg='white', bg='#704C25',
