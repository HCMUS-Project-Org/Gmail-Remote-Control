...
class Entrance_UI(Canvas):
    def __init__(self, parent):
        ...
        self.entry_image = PhotoImage(
            file=abs_path("entry_image.png"))
        self.place(x=0, y=0)
        self.input = tk.StringVar(self)
        entry_bg = tk.Label(self, image=self.entry_image)
        entry_bg.place(x=552.0, y=300.5, width=320.0, height=58.0)
        ...
        self.myFont = font.Font(family='Helvetica', size=16)
